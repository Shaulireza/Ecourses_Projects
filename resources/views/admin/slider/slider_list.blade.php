            ...
            @forelse ($data as $s)
                <tr>
                    ...
                    <td class="d-flex gap-3">
                       <div>
                        <a class="btn btn-primary btn-sm" href="{{ route('slider.edit', $s->id) }}"><i class="fa fa-edit" ></i> </a>
                       </div>
                        <div>
                            <a class="btn btn-secondary btn-sm"  href="{{ route('slider.show', $s->id) }}"><i class="fa fa-eye" ></i></a>
                        </div>
